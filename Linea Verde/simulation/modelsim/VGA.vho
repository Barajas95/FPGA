...
SIGNAL \C2|G[0]~feeder_combout\ : std_logic;
...
SIGNAL \C2|G[2]~feeder_combout\ : std_logic;
SIGNAL \C2|G[3]~feeder_combout\ : std_logic;
SIGNAL \C2|G[4]~feeder_combout\ : std_logic;
SIGNAL \C2|G[5]~feeder_combout\ : std_logic;
SIGNAL \C2|G[6]~feeder_combout\ : std_logic;
SIGNAL \C2|G[7]~feeder_combout\ : std_logic;
SIGNAL \C2|G[8]~feeder_combout\ : std_logic;
SIGNAL \C2|G[9]~feeder_combout\ : std_logic;
...
PORT MAP (
	...
	sclr => \C2|LessThan3~2_combout\,
	ena => \C2|LessThan2~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \C2|VPOS\(9));
...
-- Equation(s):
-- \C2|process_0~15_combout\ = ((\C2|VPOS\(5) & ((\C2|VPOS\(4)) # (!\C2|LessThan3~0_combout\)))) # (!\C2|process_0~4_combout\)
...
-- Equation(s):
-- \C2|process_0~6_combout\ = (!\C2|HPOS\(6) & !\C2|HPOS\(5))
...
-- Equation(s):
-- \C2|LessThan2~0_combout\ = (\C2|HPOS\(8) & (\C2|HPOS\(9) & ((\C2|HPOS\(7)) # (!\C2|process_0~6_combout\))))
...
-- Equation(s):
-- \C2|process_0~0_combout\ = (!\C2|HPOS\(0) & (!\C2|HPOS\(1) & (!\C2|HPOS\(2) & !\C2|HPOS\(3))))
...
-- Equation(s):
-- \C2|process_0~1_combout\ = (\C2|HPOS\(6) & (((!\C2|HPOS\(5))) # (!\C2|HPOS\(4)))) # (!\C2|HPOS\(6) & ((\C2|HPOS\(5)) # ((\C2|HPOS\(4) & !\C2|process_0~0_combout\))))
...
-- Equation(s):
-- \C2|process_0~2_combout\ = (\C2|HPOS\(7)) # ((\C2|HPOS\(9)) # ((\C2|HPOS\(8)) # (!\C2|process_0~1_combout\)))
...
-- Equation(s):
-- \C2|LessThan3~1_combout\ = (!\C2|VPOS\(7) & (!\C2|VPOS\(8) & (!\C2|VPOS\(6) & !\C2|VPOS\(5))))
...
-- Equation(s):
-- \C2|LessThan3~0_combout\ = (((!\C2|VPOS\(1) & !\C2|VPOS\(0))) # (!\C2|VPOS\(3))) # (!\C2|VPOS\(2))
...
-- Equation(s):
-- \C2|LessThan3~2_combout\ = (\C2|VPOS\(9) & ((\C2|VPOS\(4)) # ((!\C2|LessThan3~0_combout\) # (!\C2|LessThan3~1_combout\))))
...
-- Equation(s):
-- \C2|process_0~4_combout\ = (!\C2|VPOS\(9) & (!\C2|VPOS\(6) & (!\C2|VPOS\(7) & !\C2|VPOS\(8))))
...
-- Equation(s):
-- \C2|process_0~9_combout\ = ((\C2|HPOS\(9)) # ((!\C2|HPOS\(7)) # (!\C2|HPOS\(8)))) # (!\C2|HPOS\(6))
...
-- Equation(s):
-- \C2|process_0~8_combout\ = (\C2|HPOS\(3) & (((\C2|HPOS\(5)) # (!\C2|HPOS\(4))) # (!\C2|HPOS\(2)))) # (!\C2|HPOS\(3) & (((\C2|HPOS\(4)) # (!\C2|HPOS\(5)))))
...
-- Equation(s):
-- \C2|process_0~7_combout\ = (\C2|HPOS\(2) & (!\C2|HPOS\(4) & ((\C2|HPOS\(1)) # (\C2|HPOS\(0)))))
...
-- Equation(s):
-- \C2|process_0~10_combout\ = (!\C2|process_0~9_combout\ & (!\C2|process_0~8_combout\ & !\C2|process_0~7_combout\))
...
\C2|G[0]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \C2|G[0]~feeder_combout\ = \C2|process_0~10_combout\
...
PORT MAP (
	...
	combout => \C2|G[0]~feeder_combout\);

-- Location: LCCOMB_X41_Y50_N12
\C2|process_0~11\ : cycloneii_lcell_comb
-- Equation(s):
-- \C2|process_0~11_combout\ = (!\C2|VPOS\(2) & (!\C2|VPOS\(4) & (!\C2|VPOS\(5) & !\C2|VPOS\(3))))
...
-- Equation(s):
-- \C2|process_0~12_combout\ = (!\C2|VPOS\(1) & (!\C2|VPOS\(0) & \C2|process_0~11_combout\))
...
PORT MAP (
	dataa => \C2|VPOS\(1),
	datac => \C2|VPOS\(0),
	datad => \C2|process_0~11_combout\,
	combout => \C2|process_0~12_combout\);

-- Location: LCCOMB_X42_Y50_N26
\C2|process_0~14\ : cycloneii_lcell_comb
-- Equation(s):
-- \C2|process_0~14_combout\ = (\C2|HPOS\(8)) # ((\C2|HPOS\(9)) # ((!\C2|process_0~6_combout\ & \C2|HPOS\(7))))
...
-- Equation(s):
-- \C2|process_0~13_combout\ = (!\C2|HPOS\(7) & (!\C2|HPOS\(4) & (\C2|process_0~6_combout\ & \C2|process_0~0_combout\)))
...
-- Equation(s):
-- \C2|process_0~16_combout\ = (\C2|process_0~15_combout\ & (((!\C2|process_0~14_combout\ & !\C2|process_0~13_combout\)))) # (!\C2|process_0~15_combout\ & (((!\C2|process_0~14_combout\ & !\C2|process_0~13_combout\)) # (!\C2|process_0~12_combout\)))
...
PORT MAP (
	clk => \C1|CLKOUT~clkctrl_outclk\,
	datain => \C2|G[0]~feeder_combout\,
	aclr => \C2|process_0~16_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \C2|G\(0));
...
PORT MAP (
	clk => \C1|CLKOUT~clkctrl_outclk\,
	datain => \C2|process_0~10_combout\,
	aclr => \C2|process_0~16_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \C2|G\(1));
...
\C2|G[2]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \C2|G[2]~feeder_combout\ = \C2|process_0~10_combout\
...
PORT MAP (
	datad => \C2|process_0~10_combout\,
	combout => \C2|G[2]~feeder_combout\);

-- Location: LCFF_X41_Y50_N17
\C2|G[2]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \C1|CLKOUT~clkctrl_outclk\,
	datain => \C2|G[2]~feeder_combout\,
	aclr => \C2|process_0~16_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \C2|G\(2));
...
\C2|G[3]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \C2|G[3]~feeder_combout\ = \C2|process_0~10_combout\
...
PORT MAP (
	datad => \C2|process_0~10_combout\,
	combout => \C2|G[3]~feeder_combout\);

-- Location: LCFF_X41_Y50_N19
\C2|G[3]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \C1|CLKOUT~clkctrl_outclk\,
	datain => \C2|G[3]~feeder_combout\,
	aclr => \C2|process_0~16_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \C2|G\(3));
...
\C2|G[4]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \C2|G[4]~feeder_combout\ = \C2|process_0~10_combout\
...
PORT MAP (
	datad => \C2|process_0~10_combout\,
	combout => \C2|G[4]~feeder_combout\);

-- Location: LCFF_X41_Y50_N9
\C2|G[4]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \C1|CLKOUT~clkctrl_outclk\,
	datain => \C2|G[4]~feeder_combout\,
	aclr => \C2|process_0~16_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \C2|G\(4));
...
\C2|G[5]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \C2|G[5]~feeder_combout\ = \C2|process_0~10_combout\
...
PORT MAP (
	datad => \C2|process_0~10_combout\,
	combout => \C2|G[5]~feeder_combout\);

-- Location: LCFF_X41_Y50_N3
\C2|G[5]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \C1|CLKOUT~clkctrl_outclk\,
	datain => \C2|G[5]~feeder_combout\,
	aclr => \C2|process_0~16_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \C2|G\(5));
...
\C2|G[6]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \C2|G[6]~feeder_combout\ = \C2|process_0~10_combout\
...
PORT MAP (
	datad => \C2|process_0~10_combout\,
	combout => \C2|G[6]~feeder_combout\);

-- Location: LCFF_X41_Y50_N29
\C2|G[6]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \C1|CLKOUT~clkctrl_outclk\,
	datain => \C2|G[6]~feeder_combout\,
	aclr => \C2|process_0~16_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \C2|G\(6));
...
\C2|G[7]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \C2|G[7]~feeder_combout\ = \C2|process_0~10_combout\
...
PORT MAP (
	datad => \C2|process_0~10_combout\,
	combout => \C2|G[7]~feeder_combout\);

-- Location: LCFF_X41_Y50_N31
\C2|G[7]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \C1|CLKOUT~clkctrl_outclk\,
	datain => \C2|G[7]~feeder_combout\,
	aclr => \C2|process_0~16_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \C2|G\(7));
...
\C2|G[8]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \C2|G[8]~feeder_combout\ = \C2|process_0~10_combout\
...
PORT MAP (
	datad => \C2|process_0~10_combout\,
	combout => \C2|G[8]~feeder_combout\);

-- Location: LCFF_X41_Y50_N1
\C2|G[8]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \C1|CLKOUT~clkctrl_outclk\,
	datain => \C2|G[8]~feeder_combout\,
	aclr => \C2|process_0~16_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \C2|G\(8));
...
\C2|G[9]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \C2|G[9]~feeder_combout\ = \C2|process_0~10_combout\
...
PORT MAP (
	datad => \C2|process_0~10_combout\,
	combout => \C2|G[9]~feeder_combout\);

-- Location: LCFF_X41_Y50_N11
\C2|G[9]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \C1|CLKOUT~clkctrl_outclk\,
	datain => \C2|G[9]~feeder_combout\,
	aclr => \C2|process_0~16_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \C2|G\(9));
